...
<p style="font-size:10pt;color:DimGrey"> To test spatial patterns in reproductive assurance, I sampled mature <i>E. lewisii</i> fruits from across its entire geographic range and conducted a greenhouse experiment to investigate spatial patterns in population-level autonomous selfing ability. Some photos from my greenhouse experiment (left to right) working in the greenhouse with my labmate, Takuji Usui, <i> E. lewisii</i> flowering, flood benches covered in tulle to exclude any potential pollinators.  </p>
